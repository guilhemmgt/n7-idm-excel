 ...
 * </p>
 * <ul>
 *   <li>{@link expression.impl.ConstanteImpl#getValeur <em>Valeur</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConstanteImpl extends OperationNullaireImpl implements Constante {
	/**
	...
	protected EClass eStaticClass() {
		return ExpressionPackage.Literals.CONSTANTE;
	}
	...
	public void setValeur(float newValeur) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExpressionPackage.CONSTANTE__VALEUR, oldValeur,
					valeur));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ExpressionPackage.CONSTANTE__VALEUR:
			return getValeur();
		}
