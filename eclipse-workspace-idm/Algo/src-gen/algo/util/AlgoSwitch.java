...
public class AlgoSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
		case AlgoPackage.ALGO: {
			Algo algo = (Algo) theEObject;
			T result = caseAlgo(algo);
			if (result == null)
				result = caseDocumentable(algo);
			if (result == null)
		...
		case AlgoPackage.RESSOURCE: {
			...
			if (result == null)
				result = caseDocumentable(ressource);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AlgoPackage.FLUX: {
			Flux flux = (Flux) theEObject;
			T result = caseFlux(flux);
			if (result == null)
				result = caseDocumentable(flux);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AlgoPackage.DOCUMENTABLE: {
		...
		case AlgoPackage.DOCUMENTATION: {
